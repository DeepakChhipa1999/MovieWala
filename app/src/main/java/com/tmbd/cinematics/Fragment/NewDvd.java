...
public class NewDvd extends Fragment implements ApiClass.Api {


    private View rootView;
    private RecyclerView recyEvents;
    private NewDvdAdapter newDvdAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_newdvd, container, false);
    ...
    /*    EventModel eventModel = new EventModel(2019, "Hellboy", "Advanture", 9);
        ...
        newDvdAdapter = new NewDvdAdapter(listEvents, getActivity(), getActivity().getSupportFragmentManager());
        recyEvents.setAdapter(newDvdAdapter);
    ...
    public void onPostExecute(String result) {
        try {
            ...
            newDvdAdapter.notifyDataSetChanged();
