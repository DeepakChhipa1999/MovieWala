...
import com.tmbd.cinematics.adapter.TrandingAdapter;
...
public class Tranding extends Fragment implements ApiClass.Api {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            rootView = inflater.inflate(R.layout.fragment_tranding, container, false);
    ...
    /*    EventModel eventModel = new EventModel(2019, "Hellboy", "Advanture", 9);
        listEvents.add(eventModel);*/
            ...
            trandingAdapter = new TrandingAdapter(listEvents, getActivity(), getActivity().getSupportFragmentManager());
            recyEvents.setAdapter(trandingAdapter);
