...
public class ActorTvShowsFragment extends Fragment implements ApiClass.Api {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            Log.e("ActorTvshowsFragment", "onCreateView: " + Id);
            url = url + Id + "/tv_credits?api_key=8c50e8512e62d0f6075b091976afdde1&language=en-US";
            Log.i("url", url);
    ...
    public void onPostExecute(String result) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                String releasedate = jsonObject.optString("first_air_date");
