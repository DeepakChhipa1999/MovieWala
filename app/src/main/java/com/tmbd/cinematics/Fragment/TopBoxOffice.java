...
import com.tmbd.cinematics.adapter.TopBoxOfficeAdapter;
...
public class TopBoxOffice extends Fragment implements ApiClass.Api {
        ...
        private TopBoxOfficeAdapter topBoxOfficeAdapter;
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            rootView = inflater.inflate(R.layout.fragment_topboxoffice, container, false);
    ...
    /*    EventModel eventModel = new EventModel(2019, "Hellboy", "Advanture", 9);
        listEvents.add(eventModel);*/
            ...
            topBoxOfficeAdapter = new TopBoxOfficeAdapter(listEvents, getActivity(), getActivity().getSupportFragmentManager());
            recyEvents.setAdapter(topBoxOfficeAdapter);
