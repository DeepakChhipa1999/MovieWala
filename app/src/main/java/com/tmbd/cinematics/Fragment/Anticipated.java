...
public class Anticipated extends Fragment implements ApiClass.Api {


    private View rootView;
    private RecyclerView recyEvents;
    private AnticipatedAdapter anticipatedAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_anticipaed, container, false);
    ...
    /*    EventModel eventModel = new EventModel(2019, "Hellboy", "Advanture", 9);
        ...
        anticipatedAdapter = new AnticipatedAdapter(listEvents, getActivity(), getActivity().getSupportFragmentManager());
        recyEvents.setAdapter(anticipatedAdapter);
    ...
    public void onPostExecute(String result) {
        try {
            ...
            anticipatedAdapter.notifyDataSetChanged();
