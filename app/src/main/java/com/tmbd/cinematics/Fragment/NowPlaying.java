...
import com.tmbd.cinematics.adapter.NowPlayingAdapter;
...
public class NowPlaying extends Fragment implements ApiClass.Api {
        ...
        private static final String URL = "https://api.themoviedb.org/3/movie/popular?api_key=8c50e8512e62d0f6075b091976afdde1&language=en-US&page=1\n";
    ...
    /*    EventModel eventModel = new EventModel(2019, "Hellboy", "Advanture", 9);
        listEvents.add(eventModel);*/
         new ApiClass(this,getActivity()).execute(URL);
            ...
            nowPlayingAdapter = new NowPlayingAdapter(listEvents, getActivity(), getActivity().getSupportFragmentManager());
            recyEvents.setAdapter(nowPlayingAdapter);
