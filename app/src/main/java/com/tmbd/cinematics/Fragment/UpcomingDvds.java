...
import com.tmbd.cinematics.adapter.UpcomingAdapter;
import com.tmbd.cinematics.adapter.UpcomingDvdsAdapter;
...
public class UpcomingDvds extends Fragment implements ApiClass.Api {
        ...
        private UpcomingDvdsAdapter upcomingDvdsAdapter;
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            rootView = inflater.inflate(R.layout.fragment_upcomingdvds, container, false);
    ...
    /*    EventModel eventModel = new EventModel(2019, "Hellboy", "Advanture", 9);
        listEvents.add(eventModel);*/
            ...
            upcomingDvdsAdapter = new UpcomingDvdsAdapter(listEvents, getActivity(), getActivity().getSupportFragmentManager());
            recyEvents.setAdapter(upcomingDvdsAdapter);
    ...
    public void onPostExecute(String result) {
        try {
            ...
            upcomingDvdsAdapter.notifyDataSetChanged();
