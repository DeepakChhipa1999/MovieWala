...
public class Upcoming extends Fragment implements ApiClass.Api {
        ...
        private static final String URL = "https://api.themoviedb.org/3/movie/upcoming?api_key=8c50e8512e62d0f6075b091976afdde1&language=en-US&page=1";
    ...
    /*    EventModel eventModel = new EventModel(2019, "Hellboy", "Advanture", 9);
        listEvents.add(eventModel);*/
            ...
            upcomingAdapter = new UpcomingAdapter(listEvents, getActivity(), getActivity().getSupportFragmentManager());
            recyEvents.setAdapter(upcomingAdapter);
