...
public class NewDvdAdapter extends RecyclerView.Adapter<NewDvdAdapter.ViewHolder> {
    ...
    public NewDvdAdapter(ArrayList<EventModel> data, Context context, FragmentManager fragmentManager) {
        listData = data;
    ...
    @NonNull
    @Override
    public NewDvdAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_event, parent, false);
        return new ViewHolder(view);
    }

    public void onBindViewHolder(@NonNull final NewDvdAdapter.ViewHolder holder, final int position) {
