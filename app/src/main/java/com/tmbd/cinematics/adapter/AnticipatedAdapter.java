...
public class AnticipatedAdapter extends RecyclerView.Adapter<AnticipatedAdapter.ViewHolder> {
    ...
    public AnticipatedAdapter(ArrayList<EventModel> data, Context context, FragmentManager fragmentManager) {
        listData = data;
...
/*    @Override
    ...
    @NonNull
    @Override
    public AnticipatedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull final AnticipatedAdapter.ViewHolder holder, final int position) {
