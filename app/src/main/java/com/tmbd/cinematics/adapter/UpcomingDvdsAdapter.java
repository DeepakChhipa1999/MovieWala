...
public class UpcomingDvdsAdapter extends RecyclerView.Adapter<UpcomingDvdsAdapter.ViewHolder>{
        ...
        public UpcomingDvdsAdapter(ArrayList<EventModel> data, Context context, FragmentManager fragmentManager) {
            listData = data;
        ...
        @NonNull
        @Override
        public UpcomingDvdsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_event, parent, false);
            return new ViewHolder(view);
        }

        public void onBindViewHolder(@NonNull final UpcomingDvdsAdapter.ViewHolder holder, final int position) {
