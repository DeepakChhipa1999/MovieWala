...
public class TopRatedAdapter extends RecyclerView.Adapter<TopRatedAdapter.ViewHolder>{
        ...
        public TopRatedAdapter(ArrayList<EventModel> data, Context context, FragmentManager fragmentManager) {
            listData = data;
        ...
        public void onBindViewHolder(@NonNull final TopRatedAdapter.ViewHolder holder, final int position) {
