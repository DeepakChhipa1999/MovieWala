...
public class TrandingAdapter extends RecyclerView.Adapter<TrandingAdapter.ViewHolder> {
        ...
        public TrandingAdapter(ArrayList<EventModel> data, Context context, FragmentManager fragmentManager) {
            listData = data;
        ...
        @NonNull
        @Override
        public TrandingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_event, parent, false);
            return new ViewHolder(view);
        }

        public void onBindViewHolder(@NonNull final TrandingAdapter.ViewHolder holder, final int position) {
