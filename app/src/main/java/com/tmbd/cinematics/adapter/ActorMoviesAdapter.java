...
public class ActorMoviesAdapter extends RecyclerView.Adapter<ActorMoviesAdapter.ViewHolder> {
    ...
    private String BASE_IMAGE_URL = "https://image.tmdb.org/t/p/w500/";
        ...
        public ActorMoviesAdapter(ArrayList<EventModel> data, Context context, FragmentManager fragmentManager) {
            listData = data;
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.list_event1, parent, false);
        ...
        public void onBindViewHolder(@NonNull final ActorMoviesAdapter.ViewHolder holder, final int position) {
            ...
            holder.tvTitle.setText(value.getReleaseDate());
            holder.tvTitle3.setText(value.getTitile());
            holder.tvTitle2.setText(value.getCharacter());
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View view) {
                super(view);
                mView = view;
                tvTitle = view.findViewById(R.id.tv_event_year);
                tvTitle2 = view.findViewById(R.id.tv_event_char);
                tvTitle3 = view.findViewById(R.id.tv_picture_name);
